...
Leaderboard_setHighScore_args::~Leaderboard_setHighScore_args() noexcept {
}
...
Leaderboard_setHighScore_pargs::~Leaderboard_setHighScore_pargs() noexcept {
}
...
Leaderboard_getTop20_args::~Leaderboard_getTop20_args() noexcept {
}
...
Leaderboard_getTop20_pargs::~Leaderboard_getTop20_pargs() noexcept {
}
...
Leaderboard_getTop20_result::~Leaderboard_getTop20_result() noexcept {
}
...
Leaderboard_getTop20_presult::~Leaderboard_getTop20_presult() noexcept {
}
...
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("setHighScore", ::apache::thrift::protocol::T_ONEWAY, cseqid);
...
::std::shared_ptr< ::apache::thrift::TProcessor > LeaderboardProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< LeaderboardIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< LeaderboardIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new LeaderboardProcessor(handler));
  return processor;
}

void LeaderboardConcurrentClient::setHighScore(const int32_t playerId, const int32_t highScore)
{
  send_setHighScore(playerId, highScore);
}

void LeaderboardConcurrentClient::send_setHighScore(const int32_t playerId, const int32_t highScore)
{
  int32_t cseqid = 0;
...
void LeaderboardConcurrentClient::getTop20(std::map<int32_t, int32_t> & _return)
{
  int32_t seqid = send_getTop20();
  recv_getTop20(_return, seqid);
}

int32_t LeaderboardConcurrentClient::send_getTop20()
{
...
void LeaderboardConcurrentClient::recv_getTop20(std::map<int32_t, int32_t> & _return, const int32_t seqid)
{
